...
class RVReportResolverTests {
    private val resolver = RVReportResolver(createPNUnifer())
    ...
    fun `valid data can be resolved from client`() {
        ...
        assertEquals(ReportType.SV_RV, converted.reportType)
    }
